...
ActiveRecord::Schema.define(version: 2021_10_07_082206) do
  ...
  create_table "buy_item_infos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "item_id", null: false
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_buy_item_infos_on_item_id"
    t.index ["user_id"], name: "index_buy_item_infos_on_user_id"
  end
